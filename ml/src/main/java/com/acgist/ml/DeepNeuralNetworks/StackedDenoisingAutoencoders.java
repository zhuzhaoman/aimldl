	...
	public static void main(String[] args) {
		...
		for (int pattern = 0; pattern < patterns; pattern++) {
			for (int n = 0; n < train_N_each; n++) {
				...
				for (int i = 0; i < nIn; i++) {
					if ((n_ >= train_N_each * pattern && n_ < train_N_each * (pattern + 1)) && (i >= nIn_each * pattern && i < nIn_each * (pattern + 1))) {
			...
			for (int n = 0; n < validation_N_each; n++) {
				...
				for (int i = 0; i < nIn; i++) {
					if ((n_ >= validation_N_each * pattern && n_ < validation_N_each * (pattern + 1)) && (i >= nIn_each * pattern && i < nIn_each * (pattern + 1))) {
			...
			for (int n = 0; n < test_N_each; n++) {
				...
				for (int i = 0; i < nIn; i++) {
					if ((n_ >= test_N_each * pattern && n_ < test_N_each * (pattern + 1)) && (i >= nIn_each * pattern && i < nIn_each * (pattern + 1))) {
